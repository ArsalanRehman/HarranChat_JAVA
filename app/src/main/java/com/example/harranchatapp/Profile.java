...
//Fotoğrafları veritabanda depolamak için Firebase Storage kullanımı
        FirebaseStorage.getInstance().getReference("images/"+ UUID.randomUUID().toString()).putFile(imagePath).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                //Kullanıcı tarafından yüklenmiş Fotoğrafın URL alınacak
            ...
            //Fotoğraf yükleme esnasında progess gösteren fonksiyon
    ...
    //Kullanıcı tarafından yüklennmiş fotonun URL alıp "Profile Picture" olarak girilecek
